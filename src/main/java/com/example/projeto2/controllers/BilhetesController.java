...
public class BilhetesController {
    ...
    @GetMapping("/listaEventos/listaBilhetes")
    ...
    @GetMapping("/bilhetes/newBilhete")
    ...
    @GetMapping("/listaEventos/listaBilhetes/comprarBilhetes/{id}")
